...
<html>
    <head>
        ...
        Expose the main application to HTML pages-->
          <script type="module">
            ...
            //app is in the app namespace. This visibility is important for
            //building events in HTML. E.g., onclick="app.current.login()"
            window.app = app.app;
            //
    ...
    <body>
      <div class="header">
          ...
          <div id="logo">
                <div>
                    <img src="pictures/tracker.png" height="50" width="100">
                </div>
      ...
      <div class="footer">
          <div id="developer">
              <img src="pictures/kaniu.jpg" alt="developer's image" class="img_dev">
          </div>
